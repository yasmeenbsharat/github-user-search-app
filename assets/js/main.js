...
function displayUserInformation() {
    const result = `    
     <div class="container  col-xl-8 col-xxl-6  bg-dark-mode-element p-5 rounded-4 d-flex justify-content-between  ">
    ...
    <div class="user-profile d-flex justify-content-between flex-column flex-lg-row  flex-lg-wrap w-100">
        <div class="name">
     ...
     <span class="my-2 fs-6 d-block"> Joined ${user.created_at.substring(0, 10)}</span> 
    </div>
    <div class="card-item d-flex justify-content-between w-100 bg-dark-mode rounded-4 p-1 text-start mt-5">
        <div class="item p-3">
            <h6>Repos</h6>
    ...
    <div class="d-flex justify-content-between w-100  flex-column flex-lg-row  flex-lg-wrap  mt-1 card-item ">
